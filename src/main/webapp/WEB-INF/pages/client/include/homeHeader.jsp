			...
			<div class="top-header">
				...
				<div class="wrap">
					...
					<div class="logo">
						...
						<a href="<%=request.getContextPath()%>/">AnhTu Store</a>
					...
					<div class="top-nav">
						<ul>
							...
							<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Thể loại
									<span class="caret"></span></a>
								<ul class="dropdown-menu" style="background: white" id="danhmuc2">
								</ul>
							</li>
