		...
		<div class="wrap">
			<div class="image-slider">
				...
				<ul class="rslides" id="slider1">
					<li><img src="Frontend/img/logo1.png" style="max-width: 1200px" alt=""></li>
					<li><img src="Frontend/img/logo2.png" style="max-width: 1200px" alt=""></li>
					<li><img src="Frontend/img/logo3.png" style="max-width: 1200px" alt=""></li>
				</ul>
				<!-- Slideshow 2 -->
			</div>
			<!--End-image-slider---->
